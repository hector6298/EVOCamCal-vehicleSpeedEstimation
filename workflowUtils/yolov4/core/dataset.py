...
class Dataset(object):
    ...
    def __init__(self, cfgDict, is_training: bool, dataset_type: str = "converted_coco"):
        self.tiny = cfgDict.tiny
        self.strides, self.anchors, NUM_CLASS, XYSCALE = utils.load_config(cfgDict)
